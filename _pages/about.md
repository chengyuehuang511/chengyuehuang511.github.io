...
I graduated with BS in Statistics from <img src="{{ 'images/RUC.png' | relative_url }}" alt="RUC logo" class="logo logo-wide"> [Renmin University of China](https://en.ruc.edu.cn). I was fortunate to work with Prof. [Hongteng Xu](https://hongtengxu.github.io/) in Structured Data Science Lab (SDSL).
